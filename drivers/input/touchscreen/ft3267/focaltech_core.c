...
int FTS_NOT_TP = 0;
int FTS_Different_Modules = 0; //20181221 add by JanChen
EXPORT_SYMBOL(FTS_Different_Modules);//20181221 add by JanChen
EXPORT_SYMBOL(FTS_NOT_TP);
...
static int fts_read_touchdata(struct fts_ts_data *data)
{
    ...
    for (i = 0; i < max_touch_num; i++) {
        ...
        data->touch_point++;
/*[Arima_4101][allen_yu] Upgrade focaltech touch firmware to V11 20181004 begin*/
/*[Arima_4101][allen_yu] change the report point location 20180914 begin*/
//#if 1
//        events[i].y = ((buf[FTS_TOUCH_X_H_POS + base] & 0x0F) << 8) +
//                      (buf[FTS_TOUCH_X_L_POS + base] & 0xFF);
//        events[i].x = ((buf[FTS_TOUCH_Y_H_POS + base] & 0x0F) << 8) +
...
/*[Arima_4101][allen_yu] temp solution to rotate touch 180 degree 20180912 begin*/
#if 0
        events[i].x = 480 - events[i].x;
#endif
/*[Arima_4101][allen_yu] 20180912 end*/
/*[Arima_4101][allen_yu] 20180914 end*/
/*[Arima_4101][allen_yu] 20181004 end*/
...
/*[Arima_4101][allen_yu] 20181227 end*/
#endif
printk("Allen: fw upgrade success");
#if defined(CONFIG_FB)
...
printk("Allen: call back func success");
#elif defined(CONFIG_HAS_EARLYSUSPEND)
