...
/*[Arima_4101][allen_yu] Add touch_fw_ver file node for PCBA function test 20180913 begin*/
        num_read_chars = snprintf(buf, PAGE_SIZE, "Focaltech : 0x%02x\n", fwver);
/*[Arima_4101][allen_yu] 20180913 end*/
