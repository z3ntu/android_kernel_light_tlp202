...
#define FTS_INI_FILE_PATH2              "/mnt/sdcard/tpselftest.ini"
...
struct ft3417_test_data {
    ...
    int ft3417_test_data_count;                                       // test data count in testdata.csv
    char *testresult;
    int testresult_len;
    u8 va_touch_thr;
    u8 key_touch_thr;
...
extern struct test_funcs *ft3417_test_funcs_list[];
extern struct test_ic_type ft3417_ic_types[];
extern struct ft3417_test_data ft3417_test_data;

int ft3417_init_test_funcs(u32 ic_type);
u32 ft3417_ic_table_get_ic_code_from_ic_name(char *strIcName);
...
#define FTS_TEST_SAVE_INFO(fmt, args...)  do { \
    if (ft3417_test_data.testresult) { \
        ft3417_test_data.testresult_len += snprintf( \
        ft3417_test_data.testresult + ft3417_test_data.testresult_len, \
