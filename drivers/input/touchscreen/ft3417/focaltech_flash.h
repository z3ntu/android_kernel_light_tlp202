...
*****************************************************************************/
extern struct ft3417_upgrade *ft3417_fwupgrade;
...
int ft3417_flash_write_buf(struct i2c_client *client, u32 saddr, u8 *buf, u32 len, u32 delay);
